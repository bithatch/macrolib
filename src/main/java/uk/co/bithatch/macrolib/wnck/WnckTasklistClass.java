...
/**
 * <i>native declaration : libwnck/tasklist.h:28</i><br>
...
public class WnckTasklistClass extends Structure {
	
	/**
	 * The Class ByReference.
	 */
	public static class ByReference extends WnckTasklistClass implements Structure.ByReference {
	 ...
	 * The Class ByValue.
	 */
	public static class ByValue extends WnckTasklistClass implements Structure.ByValue {
	...
	/**
	 * Instantiates a new wnck tasklist class.
	 */
	public WnckTasklistClass() {
		super();
	}
	 ...
	 * @param peer the peer
	 */
	public WnckTasklistClass(Pointer peer) {
		super(peer);
	};
}
