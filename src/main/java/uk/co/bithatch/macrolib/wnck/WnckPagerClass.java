...
import uk.co.bithatch.macrolib.wnck.Wnck3Library.GtkContainerClass;

/**
 * <i>native declaration : libwnck/pager.h:28</i><br>
...
public class WnckPagerClass extends Structure {
	
	/**
	 * The Class ByReference.
	 */
	public static class ByReference extends WnckPagerClass implements Structure.ByReference {
	 ...
	 * The Class ByValue.
	 */
	public static class ByValue extends WnckPagerClass implements Structure.ByValue {
		
	}
	
	/** <i>native declaration : libwnck/pager.h</i> */
	...
	/**
	 * Instantiates a new wnck pager class.
	 */
	public WnckPagerClass() {
		super();
	}
	 ...
	 * Instantiates a new wnck pager class.
	 *
	 * @param parent_class C type : GtkContainerClass<br>
	 ...
	 * @param peer the peer
	 */
	public WnckPagerClass(Pointer peer) {
		super(peer);
	};
}
