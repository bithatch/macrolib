...
/**
 * <i>native declaration : libwnck/application.h:27</i><br>
...
public class WnckApplicationClass extends Structure {
	
	/**
	 * The Class ByReference.
	 */
	public static class ByReference extends WnckApplicationClass implements Structure.ByReference {
	 ...
	 * The Class ByValue.
	 */
	public static class ByValue extends WnckApplicationClass implements Structure.ByValue {
		
	}
	
	/** <i>native declaration : libwnck/application.h</i> */
	public interface icon_changed_callback extends Callback {
		 ...
		 * @param app the app
		 */
		void apply(WnckApplication app);
	}
	...
	/**
	 * Instantiates a new wnck application class.
	 */
	public WnckApplicationClass() {
		super();
	}
	 ...
	 */
	public WnckApplicationClass(GObjectClass parent_class, uk.co.bithatch.macrolib.wnck.WnckWorkspaceClass.name_changed_callback name_changed, uk.co.bithatch.macrolib.wnck.WnckClassGroupClass.icon_changed_callback icon_changed, uk.co.bithatch.macrolib.wnck.WnckActionMenuClass.pad1_callback pad1, uk.co.bithatch.macrolib.wnck.WnckActionMenuClass.pad2_callback pad2, uk.co.bithatch.macrolib.wnck.WnckActionMenuClass.pad3_callback pad3, uk.co.bithatch.macrolib.wnck.WnckActionMenuClass.pad4_callback pad4) {
		super();
	 ...
	 * @param peer the peer
	 */
	public WnckApplicationClass(Pointer peer) {
		super(peer);
	};
}
